...
public class SellerOrdersAdapter extends RecyclerView.Adapter<SellerOrdersAdapter.OrderViewHolder>{
    ArrayList<SellerOrdersModel> userOrdersList;

    public SellerOrdersAdapter(ArrayList<SellerOrdersModel> userOrdersList) {
    ...
    public void onBindViewHolder(@NonNull OrderViewHolder holder, @SuppressLint("RecyclerView") int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(holder.Title.getContext(), SellerOrdersDetail.class);
