...
public class PrivacyPolicyActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        privacyPolicy.setText("We value the trust you place in us and recognize the importance of secure transactions and information privacy. This Privacy Policy describes how Nonext Internet Private Limited and its affiliates (collectively “Nonext, we, our, us”) collect, use, share or otherwise process your personal information through Nonext Application Nonext, its mobile application).\n" +
                "\n" +
                ...
                "\n" +
                "If you enrol into our SuperCoins Loyalty Program or similar programs offered by Nonext, we will collect and store your personal information such as name, contact number, email address, communication address, date of birth, gender, zip code, lifestyle information, demographic and work details which is provided by you to Nonext or a third-party business partner that operates online/offline establishments or platforms where you can earn SuperCoins for purchase of goods and services, and redeem SuperCoins. We will also collect your information related to your transactions on Nonext platform and such third-party business partner platforms. When such third-party business partner collects your personal information directly from you, you will be governed by their privacy policies. Nonext shall not be responsible for the third-party business partner’s privacy practices or the content of their privacy policies, and we request you to read their privacy policies prior to disclosing any information.\n" +
                "\n" +
                "Nonext has onboarded certain third-party business partners on the Platform who specialise in the categories like travel ticket reservations, booking online movie tickets, paying online bills and more (Ultra-Partners). If you use the services of Ultra-Partners, you will be redirected to Ultra-Partners Applications/applications and your entry to Ultra-Partners Applications/applications will be based on your Nonext login credentials after seeking your permissions to share the data further. Nonext shall not be responsible for the Ultra-Partner’s privacy practices or the content of their privacy policies, and we request you to read their privacy policies prior to disclosing any information.\n" +
                "\n" +
                ...
                "\n" +
                "We may share personal information internally within Nonext group companies, affiliates, related companies and with other third parties for purposes of providing products and services offered by them, such as, the deferred payment options Nonext PayLater offered by Nonext Advanz Private Limited through its lending partners. These entities and affiliates may share such information with their affiliates, business partners and other third parties for the purpose of providing you their products and services and may market to you as a result of such sharing unless you explicitly opt-out.\n" +
                "\n" +
                ...
                "\n" +
                "Our Platform may provide links to other Applications or application that may collect personal information about you. We are not responsible for the privacy practices or the content of those linked Applications.\n" +
                "\n" +
                ...
                "Choice/Opt-Out\n" +
                "\n" +
                "We provide all users with the opportunity to opt-out of receiving non-essential (promotional, marketing-related) communications after setting up an account with us. If you do not wish to receive promotional communications from us, then please login into the Notification Preference page of Platform Nonext to unsubscribe/opt-out.\n" +
                "\n" +
                "Advertisements on Platform\n" +
                "\n" +
                "We use third-party advertising companies to serve ads when you visit our Platform. These companies may use information (not including your name, address, email address, or telephone number) about your visits to this and other Applications in order to provide advertisements about goods and services of interest to you.\n" +
                "\n" +
                ...
                "\n" +
                "Nonext Internet Pvt Ltd.\n" +
                "\n" +
                "Bhavnagar\n" +
                "\n" +
                "Customer Support\n" +
                "\n" +
                "You can reach our customer support team to address any of your queries or complaints related to product and services by clicking the link, selecting your order and choosing 'Need Help' option: Nonext\n" +
                "\n" +
